...
{
    /** @test */
    function ticket_codes_at_least_6_characters_long()
    {
    ...
    /** @test */
    function tickets_codes_for_the_same_ticket_id_are_the_same()
    {
        $ticketCodeGenerator = new HashidsTicketCodeGenerator('testsalt1');
    ...
    /** @test */
    function tickets_codes_for_different_ticket_ids_are_different()
    {
        $ticketCodeGenerator = new HashidsTicketCodeGenerator('testsalt1');
    ...
    function tickets_codes_generated_with_different_salts_are_different()
    {
